...
with st.sidebar:
    url = "https://raw.githubusercontent.com/AleksandrGalkin/final_project_default/main/src/img.JPG"
...
with col1:
    ...
    employment_duration = st.text_input('продолжительность трудоустройства в месяцах                (если неизвестно значение, укажите 999)')
